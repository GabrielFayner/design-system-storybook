...
export function ScreenshotButton({ onScreenshotTaken, screenshot }: FeedbackTypeStepProps) {
  ...
  return (
    <button 
      ...
      className="p-2 bg-zinc-800 rounded-md border-transparent hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-blue-500 transition-colors"
    >
